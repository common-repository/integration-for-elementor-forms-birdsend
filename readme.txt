=== Integration for Elementor forms - Birdsend ===
Contributors: webtica
Tags: birdsend, elementor, elementor pro, forms, integration, marketing, lists, bird, send, automation
...
A lightweight but feature packed Birdsend integration for Elementor forms.
With this integration you can send your form data and contacts to Birdsend as easily as the standard integrations. 
...
5. Drag and drop the form widget of Elementor Pro from the left panel onto the content area, and find the Birdsend action in the "Actions after submit" dropdown.
6. Fill your Birdsend data and Key and you are all set. All users will be added after they submit the form.
